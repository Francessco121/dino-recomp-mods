// NOTE: Modified for use in N64 recomp!
...
void DiscordCreateParamsSetDefault(struct DiscordCreateParams* params)
{
    ...
    bzero(params, sizeof(struct DiscordCreateParams));
...
RECOMP_IMPORT(".", enum EDiscordResult DISCORD_API DiscordCreate(DiscordVersion version, struct DiscordCreateParams* params, struct IDiscordCore** result));
