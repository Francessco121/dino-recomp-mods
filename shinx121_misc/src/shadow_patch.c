...
RECOMP_HOOK_RETURN("func_8004D470") void func_8004D470_hook() {
    free(D_800B98A0[0]);
    D_800B98A0[0] = malloc((RECOMP_D_800B98A0_SIZE * 2) + (RECOMP_D_800B98A8_SIZE * 2) + (RECOMP_D_800B98B0_SIZE * 2), 0x18, NULL);
    ...
    free(D_800BB158[0]);
    D_800BB158[0] = malloc((RECOMP_D_800BB158_SIZE * 2) + (RECOMP_D_800BB168_SIZE * 2) + (RECOMP_D_800BB160_SIZE * 2), 0x18, NULL);
